...
public class MainActivity extends AppCompatActivity {
    ...
    int pType = 0;
    int[] sharingArray = {0,0,0};//what's app, messenger, text
    int sharingIndex = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseClient.buildDbClient(this); //builds the database
        ...
        donate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseClient.insertNewDonation(currentDonation); //inserts the donation object to the database
        ...
        switch (item.getItemId()){
            case R.id.reportMenuItem: {
                if(currentDonation != null){
                    ...
                    Toast.makeText(this, "No report visible to view", Toast.LENGTH_LONG).show();
                }
